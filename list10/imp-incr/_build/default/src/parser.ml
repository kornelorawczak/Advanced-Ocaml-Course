...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState54 : (('s, _menhir_box_prog) _menhir_cell1_IF, _menhir_box_prog) _menhir_state
    (** State 54.
        Stack shape : IF.
        Start symbol: prog. *)

  | MenhirState56 : ((('s, _menhir_box_prog) _menhir_cell1_IF, _menhir_box_prog) _menhir_cell1_bexp, _menhir_box_prog) _menhir_state
    (** State 56.
        Stack shape : IF bexp.
        Start symbol: prog. *)

  | MenhirState59 : (('s, _menhir_box_prog) _menhir_cell1_IDENT, _menhir_box_prog) _menhir_state
    (** State 59.
        Stack shape : IDENT.
        Start symbol: prog. *)

  | MenhirState61 : (('s, _menhir_box_prog) _menhir_cell1_BEGIN, _menhir_box_prog) _menhir_state
    (** State 61.
        Stack shape : BEGIN.
        Start symbol: prog. *)

  | MenhirState62 : (('s, _menhir_box_prog) _menhir_cell1_stmt, _menhir_box_prog) _menhir_state
    (** State 62.
        Stack shape : stmt.
        Start symbol: prog. *)

  | MenhirState67 : (((('s, _menhir_box_prog) _menhir_cell1_IF, _menhir_box_prog) _menhir_cell1_bexp, _menhir_box_prog) _menhir_cell1_stmt, _menhir_box_prog) _menhir_state
    (** State 67.
...
include struct
  ...
  let _menhir_run_70 : type  ttv_stack. (ttv_stack, _menhir_box_prog) _menhir_cell1_list_var_decl_ -> _ -> _ -> _menhir_box_prog =
  ...
  and _menhir_run_60 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_IDENT as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TIMES ->
      ...
      | BEGIN | ELSE | END | EOF | IDENT _ | IF | PLUSPLUS | READ | SKIP | WHILE | WRITE ->
  ...
  and _menhir_run_69 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_WHILE, _menhir_box_prog) _menhir_cell1_bexp -> _ -> _ -> _ -> _ -> _menhir_box_prog =
  ...
  and _menhir_run_68 : type  ttv_stack. (((ttv_stack, _menhir_box_prog) _menhir_cell1_IF, _menhir_box_prog) _menhir_cell1_bexp, _menhir_box_prog) _menhir_cell1_stmt -> _ -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
  ...
  and _menhir_run_66 : type  ttv_stack. (((ttv_stack, _menhir_box_prog) _menhir_cell1_IF, _menhir_box_prog) _menhir_cell1_bexp as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
  ...
  and _menhir_run_55 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_IF as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
  ...
  and _menhir_run_61 : type  ttv_stack. ttv_stack -> _ -> _ -> (ttv_stack, _menhir_box_prog) _menhir_state -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _menhir_s ->
      ...
      | IDENT _v ->
          _menhir_run_57 _menhir_stack _menhir_lexbuf _menhir_lexer _v MenhirState61
      | BEGIN ->
          _menhir_run_61 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState61
      | END ->
  ...
  and _menhir_run_64 : type  ttv_stack. (ttv_stack, _menhir_box_prog) _menhir_cell1_BEGIN -> _ -> _ -> _ -> _menhir_box_prog =
  ...
  and _menhir_run_62 : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | IF ->
          _menhir_run_54 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState62
      | IDENT _v_0 ->
          _menhir_run_57 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 MenhirState62
      | BEGIN ->
          _menhir_run_61 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState62
      | END ->
          let _v_1 = _menhir_action_23 () in
          _menhir_run_63 _menhir_stack _menhir_lexbuf _menhir_lexer _v_1
      | _ ->
          _eRR ()
  
  and _menhir_run_63 : type  ttv_stack. (ttv_stack, _menhir_box_prog) _menhir_cell1_stmt -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v ->
  ...
  and _menhir_run_23 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_aexp as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | DIV ->
          let _menhir_stack = MenhirCell1_aexp (_menhir_stack, _menhir_s, _v) in
          _menhir_run_20 _menhir_stack _menhir_lexbuf _menhir_lexer
      | AND | BEGIN | DO | ELSE | END | EOF | EQ | GEQ | GT | IDENT _ | IF | LEQ | LT | MINUS | NEQ | OR | PLUS | PLUSPLUS | READ | RPAREN | SKIP | THEN | WHILE | WRITE ->
          let MenhirCell1_aexp (_menhir_stack, _menhir_s, e1) = _menhir_stack in
          let e2 = _v in
  ...
  let _menhir_run_06 : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | IF ->
          _menhir_run_54 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState06
      | IDENT _v_0 ->
          _menhir_run_57 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 MenhirState06
      | BEGIN ->
          _menhir_run_61 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState06
      | _ ->
          _menhir_fail ()
  ...
  let rec _menhir_run_01 : type  ttv_stack. ttv_stack -> _ -> _ -> (ttv_stack, _menhir_box_prog) _menhir_state -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _menhir_s ->
      ...
      | IDENT _v ->
          ...
          | BEGIN | IDENT _ | IF | PLUSPLUS | READ | SKIP | WHILE | WRITE ->
